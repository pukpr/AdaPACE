...
generic
   with package Math_Dof_3_Image is new Parent_Math_Dof_3.Gen_Image;
package Sal.Gen_Math.Gen_Dof_6.Gen_Image is
   pragma Elaborate_Body; -- parent is

   function Dual_Cart_Vector_Image
     (Item : in Dual_Cart_Vector_Type)
      return String;
   function Image (Item : in Dual_Cart_Vector_Type) return String renames
     Dual_Cart_Vector_Image;
