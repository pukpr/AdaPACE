...
package GNU.plotutil.fplot is
   ...
   --  size of the graphics display in physical units.
   ...
   procedure Scale (P              : in Plotter;
                    ScaleX, ScaleY : in Real'Base);
   --  Make the x and y units in the user coordinate system be the size
   --  of ScaleX and ScaleY units in the former user coordinate system.  The
