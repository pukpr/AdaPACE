...
package body Sal.Gen_Math.Gen_Vector is
   ...
   function Any (Item : in Index_Array_Boolean_Type) return Boolean is
   begin
   ...
   begin
      for I in  Result'Range loop
         Result (I) :=
            Math_Scalar.Detent (Item (I), Dead_Band (I), Upper_Limit (I));
      end loop;
      return Result;
   end Detent;
   ...
   begin
      for I in  Result'Range loop
         Result (I) :=
            Math_Scalar.To_Limit (Low => Low (I), High => High (I));
      end loop;
      return Result;
   end To_Limit;
