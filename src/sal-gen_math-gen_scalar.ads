...
--      Applied Mathematics Series 55, 1967, Library of Congress Number:
--64-60036
--
...
package Sal.Gen_Math.Gen_Scalar is
   ...
   function "mod" (Dividend, Divisor : in Real_Type) return Real_Type renames
     Modulo;
   ...
   --  A linear approximation is used for some operations when Trig.Sin <
   --First_Order_Trig.
   ...
   --
   --  Raises Ada.Numerics.Argument_Error if Trig has both elements 0.0, which
   --can only happen
   ...
   function "+"
     (Left  : in Trig_Pair_Type;
      ...
      return  Trig_Pair_Type;
   --  Find Sin_Cos {Left_Angle + Right_Angle} from Sin_Cos {Left_Angle},
   --Sin_Cos {Right_Angle}
