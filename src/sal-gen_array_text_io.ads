...
with Ada.Text_IO;
package Sal.Gen_Array_Text_Io is
   ...
   package Integer_1D is
      ...
      Default_Width             : Ada.Text_IO.Field       :=
        Init_Default_Width;
      Default_Base              : Ada.Text_IO.Number_Base :=
         Init_Default_Base;
      Default_Single_Line       : Boolean                 :=
        Init_Default_Single_Line;
      Default_Named_Association : Boolean                 :=
        Init_Default_Named_Association;
   ...
   generic
      type Element_Type is range <>;
      type Index_Type is (<>);
      type Index_Array_Element_Type is
   ...
   generic
      ...
      Init_Default_Width : in Ada.Text_IO.Field := Element_Type'Width;
      Init_Default_Setting : in Ada.Text_IO.Type_Set :=
        Ada.Text_IO.Upper_Case;
      Init_Default_Single_Line : in Boolean := True;
      Init_Default_Named_Association : in Boolean := False;
   ...
   package Enumeration_1D is
      ...
      Default_Setting           : Ada.Text_IO.Type_Set :=
      ...
      procedure Get
        (File              : in Ada.Text_IO.File_Type;
         Item              : out Index_Array_Element_Type;
         Named_Association : in Boolean := Default_Named_Association) renames
        Get_Item;
   ...
   package Private_1D is
      ...
      Default_Single_Line_Array         : Boolean :=
        Init_Default_Single_Line_Array;
      Default_Named_Association_Array   : Boolean :=
        Init_Default_Named_Association_Array;
      Default_Single_Line_Element       : Boolean :=
        Init_Default_Single_Line_Element;
      Default_Named_Association_Element : Boolean :=
        Init_Default_Named_Association_Element;
      ...
      procedure Put
        ...
        Default_Named_Association_Array;
         Single_Line_Element       : in Boolean :=
        Default_Single_Line_Element;
         Named_Association_Element : in Boolean :=
        Default_Named_Association_Element);
