...
package body Gnu.Xml_Tree.Kbase is
   ...
   begin
      ...
      if Buf (Start) = '(' then
         ...
         N.Tag := To_Unbounded_String (Buf (Start .. Index.all));
         ...
         pragma Debug (Text_Io.Put_Line ("VALUE:" & To_String (N.Tag) &
...
------------------------------------------------------------------------------
-- $id: gnu-xml_tree-kbase.adb,v 1.6 06/11/2003 22:35:17 pukitepa Exp $
------------------------------------------------------------------------------
