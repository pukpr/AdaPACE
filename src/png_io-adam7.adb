...
package body PNG_IO.Adam7 is
   ...
   -- for each pixel in the block which of the seven passes the pixel falls
   --within.
   -- This is documented in section 2.6 of the PNG specification V1.2.
   ...
   -- The next two tables give the number of scan lines and columns within an
   --8 by 8 block
   -- which are accessed on each pass. Pass 7 for example accesses all 8
   --columns of the
   -- block, but only 4 rows.

   N_Lines   : constant array (Pass_Number) of Positive range 1 .. 4 :=
     (1,
      1,
      1,
      2,
      ...
      4,
      4);
   N_Columns : constant array (Pass_Number) of Positive range 1 .. 8 :=
     (1,
      1,
      2,
      2,
   ...
   -- The two following functions map from a coordinate within a sub-image to
   --the
   -- corresponding coordinate in the whole image. There is no error checking
   --here
   ...
   function Image_Row (R : Coordinate; P : Pass_Number) return Coordinate is
      Scale  : constant array (Pass_Number) of Positive range 2 .. 8 :=
        (8,
         8,
         8,
         4,
         ...
         2,
         2);
      Offset : constant array (Pass_Number) of Natural range 0 .. 4  :=
        (0,
         0,
         4,
         0,
   ...
   function Image_Col (C : Coordinate; P : Pass_Number) return Coordinate is
      Scale  : constant array (Pass_Number) of Positive range 1 .. 8 :=
        (8,
         8,
         4,
         4,
