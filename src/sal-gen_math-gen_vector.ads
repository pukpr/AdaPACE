...
generic
   ...
   type Index_Array_Limit_Type is
     array (Index_Type) of Math_Scalar.Limit_Type;
...
package Sal.Gen_Math.Gen_Vector is
   ...
   function "-"
     (Right : in Index_Array_Real_Type)
   ...
   function Mask
     (Item : in Index_Array_Real_Type;
      Mask : in Index_Array_Boolean_Type)
      return Index_Array_Real_Type;
   ...
   function To_Limit
     (Low, High : in Index_Array_Real_Type)
      return      Index_Array_Limit_Type;

   function "and"
     (Left, Right : in Index_Array_Limit_Type)
      return        Index_Array_Limit_Type;
   ...
   procedure Scale_Limit
     (Item   : in out Index_Array_Real_Type;
      Limit  : in Real_Type;
      Scaled : out Boolean);
   -- Scale all elements of Item so they are all within +-|Limit|, but
   -- maintain direction in the vector space. Scaled is True if Item
   -- is modified, False if not.
