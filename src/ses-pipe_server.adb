...
package body Ses.Pipe_Server is
   ...
   begin
      Ses.Launch.Register_Startup_Callback (P4_Wakeup'Access);
   end;
...
begin
   Save_Action (Pp'(Pace.Msg with Set => Default));
   Save_Action (Wait_For_P4_Is_Ready'(Pace.Msg with Set => Default));
end Ses.Pipe_Server;
