...
package body Python is
   ...
   procedure Py_Initialize_Interruptible is
   ...
   procedure PySys_SetArgv is
      procedure Set_Args (C : Integer; V : System.Address);
      pragma Import (C, Set_Args, "PySys_SetArgv");
   begin
      -- Argc=0 is the command name
      Set_Args(Gnat_Argc, Gnat_Argv);
   end PySys_SetArgv;
