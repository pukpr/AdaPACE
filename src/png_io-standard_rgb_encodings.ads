...
generic
   ...
   -- encoded value will be 255, regardless of the modulus of the type.

   type Linear_Sample is mod <>;
   type sRGB_Sample is mod <>;

package PNG_IO.Standard_RGB_Encodings is

   subtype Encoded_Sample is sRGB_Sample range 0 .. 255;
