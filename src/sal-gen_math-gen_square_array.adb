...
package body Sal.Gen_Math.Gen_Square_Array is
   ...
   function Identity return Array_Type is
   ...
   function "-" (Right : in Array_Type) return Array_Type is
      Result : Array_Type;
   begin
   ...
   function "*" (Left : in Array_Type; Right : in Row_Type) return Row_Type is
      Temp   : Real_Type;
      Result : Row_Type;
   begin
      for I in  Index_Type loop
   ...
   function Square_Right (Right : in Array_Type) return Array_Type is
      Temp   : Real_Type;
      Result : Array_Type;
   begin
      for I in  Index_Type loop
   ...
   function Square_Left (Right : in Array_Type) return Array_Type is
      Temp   : Real_Type;
      Result : Array_Type;
   begin
      for I in  Index_Type loop
   ...
   function Transpose_Times (Left, Right : in Array_Type) return Array_Type is
      Temp   : Real_Type;
      Result : Array_Type;
   begin
      for I in  Index_Type loop
   ...
   function Times_Transpose (Left, Right : in Array_Type) return Array_Type is
      Temp   : Real_Type;
      Result : Array_Type;
   begin
      for I in  Index_Type loop
