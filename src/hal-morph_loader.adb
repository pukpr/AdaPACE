...
package body Hal.Morph_Loader is
   ...
   --    Track_Radius : Float;
   --    Liftbox_Rising_Velocity : Float;
   --    Liftbox_Lowering_Velocity : Float;
   ...
   Delta_D_Rising : constant Float := Liftbox_Rising_Velocity * Delta_T;
   Delta_D_Lowering : constant Float := Liftbox_Lowering_Velocity * Delta_T;
   ...
   begin
      ...
      Pace.Log.Put_Line ("front position is: ");
      Print_Pos (Front_Pos);
   ...
   procedure Adjust_Rear_Wheel_For_Str_Vert is
      ...
      Result1, Result2 : Hal.Position;
   begin
      Pace.Log.Put_Line ("inside RW: for Str_Vert");
      Hal.Geometry_And_Trig.Line_Intersect_Sphere
   ...
   procedure Adjust_Rear_Wheel_For_Str_Elev is
      ...
      Result1, Result2 : Hal.Position;
   begin
      Pace.Log.Put_Line ("inside RW: for Str_Elev");
      Get_Str_Elev_Line (P1, P2);
      Hal.Geometry_And_Trig.Line_Intersect_Sphere
        (P1, P2, Arms_Intersection_Pos, Arm2_Length,
         Num_Intersections, Result1, Result2);
   ...
   -- time-increment it moves a distance Delta_D_Rising or
   -- Delta_D_Lowering
   procedure Adjust_Lift_Box (Is_Rising : Boolean) is
   begin
      if Is_Rising then
         Inc_Or_Dec_Num (Lift_Box_Pos.Y, Delta_D_Rising, Is_Rising);
      else
         Inc_Or_Dec_Num (Lift_Box_Pos.Y, Delta_D_Lowering, Is_Rising);
