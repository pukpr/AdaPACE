...
package body Sal.Gen_Array_Text_Io is
   ...
   package body Integer_1D is
      ...
      begin
         ...
         if Item'Length > 1 then
            for I in  Index_Type'First .. Index_Type'Pred (Index_Type'Last)
            loop
   ...
   package body Unconstrained_Float_1D is
      ...
      begin
         ...
         if Item'Length > 0 then
            if Item'Length > 1 then
               for I in  Index_Type'First .. Index_Type'Pred
                                               (Index_Type'Last)
               loop
                  if Named_Association then
                     Check (File, Index_Type'Image (I) & " =>");
