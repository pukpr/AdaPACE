...
During operation from terminal can Peek and Poke at values of sense_car
...
Using P4 to launch and peek/poke 

https://github.com/user-attachments/assets/396bfe93-64f9-4f2a-b1e3-2d00ac52d927

prepend with process ID

```
1 *tlc__sense_car BOOL

1 *tlc__sense_car BOOL:TRUE
```
