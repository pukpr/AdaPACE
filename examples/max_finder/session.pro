...
proc (1, "obj/server_main", Dir, env("PACE_NODE=1"), arg("")) :- path(".", Dir).
proc (2, "obj/worker_main", Dir, env("PACE_NODE=2"), arg("")) :- path(".", Dir).
proc (3, "obj/worker_main", Dir, env("PACE_NODE=3"), arg("")) :- path(".", Dir).
