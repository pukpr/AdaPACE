...
proc (1, "obj/initiator_main", Dir, env("PACE_NODE=1"), arg("")) :- path(".", Dir).
proc (2, "obj/responder_main", Dir, env("PACE_NODE=2"), arg("")) :- path(".", Dir).
proc (3, "obj/verifier_main",  Dir, env("PACE_NODE=3"), arg("")) :- path(".", Dir).
